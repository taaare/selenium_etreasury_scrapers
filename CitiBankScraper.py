...
while True:
    ...
    continue_button_url = continue_button.get_attribute('href')

    # Open a new tab and navigate to the URL
    driver.execute_script("window.open('" + continue_button_url +"');")

    time.sleep(3)
    # Switch to the new tab (it's the last one, so -1 works)
